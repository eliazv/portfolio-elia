    ...
    <>
      ...
      >
        ...
        <div className="container mx-auto px-6 relative z-10 flex flex-col justify-center min-h-[60vh]">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-10 lg:gap-14 w-full md:max-w-6xl mx-auto">
            {/* Portrait with pop + float animation */}
            <div className="relative w-48 h-48 md:w-64 md:h-64 lg:w-72 lg:h-72 shrink-0">
