    ...
    <section id="contact" className="py-20 bg-secondary/50">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold font-heading mb-4">Contattami</h2>
          <p className="text-foreground/70 max-w-2xl mx-auto">
            Hai un progetto in mente o vuoi semplicemente salutare? Contattami utilizzando il modulo sottostante o tramite i miei recapiti diretti.
          </p>
        </div>
        
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="bg-background rounded-lg p-8 shadow-sm">
            <h3 className="text-2xl font-semibold mb-6">Inviami un messaggio</h3>
          ...
          <div className="flex flex-col justify-between">
            <div>
              ...
              <p className="text-foreground/70 mb-8">
                Preferisci contattarmi direttamente? Ecco i miei recapiti. Sarò felice di risponderti al più presto.
              </p>
            ...
            <div className="mt-12 lg:mt-0">
              <div className="glass-card p-6 rounded-lg">
                <h4 className="text-lg font-medium mb-2">Orari di disponibilità</h4>
