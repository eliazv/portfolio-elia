            ...
            {navItems.map((item) => {
              ...
              return (
                <a
                  key={item.name}
                  href={item.href}
                  className="flex items-center space-x-2 text-foreground/80 hover:text-primary font-medium transition-colors duration-200 px-3 py-2 rounded-full hover:bg-primary/10"
            ...
            {navItems.map((item) => {
              ...
              return (
                <a
                  key={item.name}
                  href={item.href}
                  className="text-foreground/80 hover:text-primary transition-colors duration-200 p-2 rounded-full hover:bg-primary/10"
                  onClick={(e) => handleNavClick(e, item.href)}
                >
